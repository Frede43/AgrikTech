...
function FarmerMessagesContent() {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-semibold text-sm truncate">{contactNames[uid] || `Acheteur #${uid}`}</p>
          ...
          {activeChat ? (
            <>
              <div className="p-4 border-b flex items-center gap-3">
                ...
                <h3 className="font-bold text-sm">{contactNames[activeChat] || `Acheteur #${activeChat}`}</h3>
              </div>
